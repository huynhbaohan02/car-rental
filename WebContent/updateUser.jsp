                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="updateUserServlet">
                        ...
                        <div class="form-outline mb-4">
                          <input type="text" name="id" id="form6Example4" class="form-control" readonly value="${up.id }" />
                          <label class="form-label" for="form6Example4">ID</label>
                        </div>
                        
                        <div class="form-outline mb-4">
                          <input type="text" name="name" id="form6Example4" class="form-control" value="${up.name }" />
                          <label class="form-label" for="form6Example4">Name</label>
                        </div>
                                         
                        <div class="form-outline mb-4">
                          <input type="text" name="email" id="form6Example3" class="form-control" value="${up.email }" />
                          <label class="form-label" for="form6Example3">Email</label>
                        </div>
           
                        <div class="form-outline mb-4">
                          <input type="text" name="date" id="form6Example4" class="form-control" value="${up.date }" />
                          <label class="form-label" for="form6Example4">Birthday</label>
                        </div>
                      
                      
                        <div class="form-outline mb-4">
                          <input type="number" name="phone" id="form6Example5" class="form-control" value="${up.phone }"/>
                          <label class="form-label" for="form6Example5">Phone</label>
                        </div>
                        
                         <div class="form-outline mb-4">
                          <input type="text" name="role" id="form6Example5" class="form-control" value="${up.role }"/>
